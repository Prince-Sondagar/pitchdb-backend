...
const sequenceMustExist = body("sequence")
  .not()
  .isEmpty();
const bodyIsArray = body().isArray();
const bodyMustExist = body()
  .not()
  .isEmpty();
const stagesIsArray = body("stages").isArray();

module.exports = {
  getLatestByCategory: [stageCategory],
  postActionSend: [sequenceMustExist],

  postActionSendsecond: [bodyIsArray],
  postActionOpened: [bodyIsArray],
  postActionReplied: [bodyIsArray],
  postActionBook: [bodyMustExist],
  postActionPostpone: [bodyMustExist],
  postActionConversation: [bodyMustExist],
  postActionRestore: [stagesIsArray]
};
