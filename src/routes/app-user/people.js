...
const { BETA_USER } = require('../../modules/common/constants/users/permissions')
...
router.all('/*', routeInterceptor.verifyPrivileges({ requiredPrivileges: [BETA_USER], allAccess: false }));
