...
module.exports = (app, callback) => {
    ...
    app.use('/profile-data', require('./app-user/profile-data'));
    app.use('/email-notification', require('./app-user/email-notification-configController'));
    ...
    app.use('/email-templates', require('./app-user/email-templates'));
    app.use('/userimage', require('./app-user/userimage'));
