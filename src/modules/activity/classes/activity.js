  ...
  constructor (data, type) {
    ...
    switch (type) {
      case 'stage':
        ...
        if (sequence.userConferenceId) {
          contactType = 'conference';
          contactText = sequence.userConferenceId.conference.eventName;
        }
        if (sequence.userMediaOutletId) {
          contactType = 'media';
          contactText = sequence.userMediaOutletId.mediaOutlet.companyName;
        }
        ...
        else if (sequence.userSpeakerId) {
          contactType = 'speaker';
          contactText = sequence.userSpeakerId.speaker.name ||
            sequence.userSpeakerId.speaker.email;
        }
