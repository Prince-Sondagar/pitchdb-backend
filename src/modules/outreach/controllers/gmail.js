...
const gmailController = {
  ...
  buildRfc2822Base64: emailData => {
    ...
    message += "To: ";
    message += (process.env.NODE_ENV === 'production' ? emailData.to : "raxpatel7061@gmail.com") + "\r\n";
    //ronstoryjr@gmail.com
    //sbeltrancaicedo@gmail.com
    //santiago@syoon.co
    message += "Subject: ";
    message += emailData.subject + "\r\n";
    message += "Content-type: text/html" + "\r\n\r\n";
    message += emailData.message + "\r\n";
    //signature ? message += "<br><br><br>\r\n\r\n":"";

    
    //message += signature + "\r\n";

    // Insert invisible gif into email that will trigger the 'opens' endpoint whenever the user opens the email
    //message += '<img src="' + BASE_BACK_URL + '/opens/outreach-sequence/' + emailData.openId + '.gif" alt="image">'
    return Buffer.from(message).toString('base64').replace(/\+/g, '-').replace(/\//g, '_').replace(/=+$/, '');
    
  },

  getConversation: (content, token, callback,emailAccountId) => {
