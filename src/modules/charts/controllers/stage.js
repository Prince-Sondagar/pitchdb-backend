...
const stagesChartController = {
  ...
  getAmountpodcast: (req, callback) => {
    ...
    switch (req.query.period) {
      case commonChartConstants.PERIOD_DAILY:
        map = function () {
          ...
          emit({ // eslint-disable-line no-undef
            fulldate: this.date.getDate() + "/" + (this.date.getMonth() + 1) + "/" + this.date.getFullYear(),
            date: this.date.getDate(), // eslint-disable-line no-invalid-this
            month: this.date.getMonth() + 1, // eslint-disable-line no-invalid-this
            userPodcastId: this.userPodcastId, // eslint-disable-line no-invalid-this   
          }, 1);
        }
        query.date = {
          $gte: new Date(req.query.dateStart + commonChartConstants.DATE_ZERO_TIME),
    ...
    OutreachSequence.mapReduce(mapReduceObject, (err, result) => {
      if (err) callback(err);
      else
        callback(null, result.results);
    })
      ...
      case commonChartConstants.PERIOD_DAILY:
        map = function () {
          ...
          emit({ // eslint-disable-line no-undef
            ...
            date: this.date.getDate(), // eslint-disable-line no-invalid-this
            month: this.date.getMonth() + 1, // eslint-disable-line no-invalid-this
            userSpeakerId: this.userSpeakerId, // eslint-disable-line no-invalid-this   
          }, 1);
        }
        query.date = {
          $gte: new Date(req.query.dateStart + commonChartConstants.DATE_ZERO_TIME),
      ...
      case commonChartConstants.PERIOD_DAILY:
        map = function () {
          ...
          emit({ // eslint-disable-line no-undef
            ...
            date: this.date.getDate(), // eslint-disable-line no-invalid-this
            month: this.date.getMonth() + 1, // eslint-disable-line no-invalid-this
            userMediaOutletId: this.userMediaOutletId, // eslint-disable-line no-invalid-this   
          }, 1);
        }
        query.date = {
          $gte: new Date(req.query.dateStart + commonChartConstants.DATE_ZERO_TIME),
  ...
  getAmountconference: (req, callback) => {
      ...
      case commonChartConstants.PERIOD_DAILY:
        map = function () {
          ...
          emit({ // eslint-disable-line no-undef
            ...
            date: this.date.getDate(), // eslint-disable-line no-invalid-this
            month: this.date.getMonth() + 1, // eslint-disable-line no-invalid-this
            userConferenceId: this.userConferenceId, // eslint-disable-line no-invalid-this   
          }, 1);
        }
        query.date = {
          $gte: new Date(req.query.dateStart + commonChartConstants.DATE_ZERO_TIME),
  ...
  getAmountassociation: (req, callback) => {
      ...
      case commonChartConstants.PERIOD_DAILY:
        map = function () {
          ...
          emit({ // eslint-disable-line no-undef
            ...
            date: this.date.getDate(), // eslint-disable-line no-invalid-this
            month: this.date.getMonth() + 1, // eslint-disable-line no-invalid-this
            userEventOrganizationId: this.userEventOrganizationId, // eslint-disable-line no-invalid-this   
          }, 1);
        }
        query.date = {
          $gte: new Date(req.query.dateStart + commonChartConstants.DATE_ZERO_TIME),
  ...
  //booked data
  getAmountbookedpodcast: (req, callback) => {
      ...
      case commonChartConstants.PERIOD_DAILY:
        map = function () {
          ...
          emit({ // eslint-disable-line no-undef
            ...
            date: this.date.getDate(), // eslint-disable-line no-invalid-this
            month: this.date.getMonth() + 1, // eslint-disable-line no-invalid-this
            estimate_revenue: this.estimatedrevenue,
            userPodcastId: this.userPodcastId, // eslint-disable-line no-invalid-this   
          }, 1);
        }
        query.date = {
  ...
  //speaker start
  getAmountbookedspeaker: (req, callback) => {
  ...
  //speaker end
  getAmountbookedmedia: (req, callback) => {
  ...
  getAmountbookedconference: (req, callback) => {
  ...
  getAmountbookedassociation: (req, callback) => {
