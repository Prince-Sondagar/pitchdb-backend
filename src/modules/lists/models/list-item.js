...
let listItem = new mongoose.Schema({
  ...
  userSpeaker: { type: Schema.Types.ObjectId, ref: 'userSpeaker', required: false },
...
listItem.index({ listId: 1, userSpeaker: 1 }, { unique: true, partialFilterExpression: { userSpeaker: { $exists: true } } });
